...
| --- | --- | --- | --- | --- |
| 6 | <ul style="list-style-type:none; margin:0; padding-left:0;"><li>- <b>Tìm hiểu Amazon EC2:</b> Học lý thuyết EC2: Instance Types, EC2 Lifecycle (Launch, Stop, Terminate, Reboot)</li><li>- <b>Phân loại AMI:</b> Tìm hiểu Amazon Machine Image (Quick Start AMI, Custom AMI, Marketplace AMI)</li></ul> | 01/05/2026 | 01/05/2026 | <https://cloudjourney.awsstudygroup.com/> |
| 7 | <ul style="list-style-type:none; margin:0; padding-left:0;"><li>- <b>Tạo SSH Key Pair:</b> Khởi tạo Key Pair `.pem` an toàn cho kết nối máy chủ Linux</li><li>- <b>Launch EC2 Instance:</b> Khởi tạo EC2 Amazon Linux 2023 (`t3.micro`), gán Public IP và Security Group</li></ul> | 02/05/2026 | 02/05/2026 | <https://cloudjourney.awsstudygroup.com/> |
| CN | <ul style="list-style-type:none; margin:0; padding-left:0;"><li>- <b>Kết nối SSH:</b> Truy cập máy chủ EC2 Linux từ máy cục bộ bằng SSH client (`ssh -i key.pem ec2-user@public-ip`)</li><li>- <b>Cập nhật hệ thống:</b> Cập nhật các gói phần mềm hệ thống (`sudo dnf update -y`)</li></ul> | 03/05/2026 | 03/05/2026 | <https://cloudjourney.awsstudygroup.com/> |
| 2 | <ul style="list-style-type:none; margin:0; padding-left:0;"><li>- <b>Quản lý EBS Volume:</b> Tìm hiểu các loại EBS (gp3, io2, st1), khởi tạo thêm ổ đĩa EBS bổ sung</li><li>- <b>Mount ổ đĩa:</b> Thực hành `fdisk`, định dạng filesystem (ext4/xfs) và mount ổ đĩa EBS mới vào thư mục `/data`</li></ul> | 04/05/2026 | 04/05/2026 | <https://cloudjourney.awsstudygroup.com/> |
| 3 | <ul style="list-style-type:none; margin:0; padding-left:0;"><li>- <b>Tạo EBS Snapshot:</b> Thực hành chụp ảnh ổ đĩa (Snapshot) thủ công cho EBS Volume</li><li>- <b>Cấu hình AWS Backup:</b> Cấu hình AWS Backup Plan tự động sao lưu định kỳ ổ đĩa EBS và tạo Custom AMI từ instance</li></ul> | 05/05/2026 | 05/05/2026 | <https://cloudjourney.awsstudygroup.com/> |
| 4 | <ul style="list-style-type:none; margin:0; padding-left:0;"><li>- <b>Cài đặt Nginx:</b> Cài đặt Web Server Nginx trên máy chủ EC2 Linux (`sudo dnf install nginx -y`)</li><li>- <b>Cấu hình Web Server:</b> Viết trang `index.html` tùy biến, khởi động dịch vụ Nginx và kích hoạt auto-start</li></ul> | 06/05/2026 | 06/05/2026 | <https://cloudjourney.awsstudygroup.com/> |
| 5 | <ul style="list-style-type:none; margin:0; padding-left:0;"><li>- <b>Kiểm thử Web Server:</b> Mở port HTTP (80) trên Security Group và kiểm tra truy cập Nginx qua trình duyệt</li><li>- <b>Đánh giá & Tổng kết:</b> Rà soát dung lượng EBS, quy trình Backup và viết báo cáo tổng kết tuần 3</li></ul> | 07/05/2026 | 07/05/2026 | <https://cloudjourney.awsstudygroup.com/> |
